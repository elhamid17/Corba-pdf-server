...
export default function Footer() {
  return (
    <footer className="mt-12 border-t border-ink-200/70 bg-white/70 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 grid gap-4 sm:grid-cols-2 items-center">
        <div className="flex items-center gap-2.5">
          ...
          <div className="text-sm">
            <p className="font-semibold text-ink-800">CORBA PDF Suite</p>
            <p className="text-ink-500 text-xs">Traitement PDF distribué — JacORB · PDFBox · Spring Boot</p>
          </div>
        </div>
